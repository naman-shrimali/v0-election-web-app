            ...
            <div className="font-hindi text-lg md:text-xl text-muted-foreground leading-relaxed space-y-6 text-center">
              ...
              <p>
                ...
                <span className="text-foreground">
                  को-चेयरमैन, बार काउंसिल ऑफ इंडिया
                </span>
                {" "}एवं{" "}
                <span className="text-foreground">
                  पूर्व चेयरमैन, बार काउंसिल ऑफ राजस्थान
                </span>
                ,{" "}
                आगामी चुनाव में{" "}
                <span className="font-semibold text-primary">
                  सदस्य बार काउंसिल ऑफ राजस्थान के
                </span>{" "}
                उम्मीदवार के रूप में आपके सामने उपस्थित हूं।
              </p>
